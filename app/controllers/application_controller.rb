class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:email, :password, :lastname, :firstname, :rank, :role, :unit_assign) }
    devise_parameter_sanitizer.for(:account_update) do |u|
      u.permit(:firstname, :lastname, :rank, :role, :email, :unit_assign, :password, :password_confirmation, :current_password)
    end
  end
